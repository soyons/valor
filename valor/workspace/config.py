...
from valor.workspace.settings import WorkspaceSettings
from valor.utils.py_io import get_python_objects_from_module
...
def get_workspace_objects_from_file(resource_file: Path) -> dict:
    ...
    try:
        ...
        if not k8s_resources_available and create_default_k8s_resources:
            from valor.k8s.resources import K8sResources, K8sResource, K8sApp, CreateK8sResource
        ...
        if not aws_resources_available and create_default_aws_resources:
            from valor.aws.resources import AwsResources, AwsResource, AwsApp
...
class WorkspaceConfig(BaseModel):
    ...
    def get_resources(
        ...
        from valor.utils.load_env import load_env
