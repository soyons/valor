...
from valor.cli.ws.ws_cli import ws_cli
from valor.cli.k.k_cli import k_cli
from valor.utils.log import set_log_level_to_debug, logger
...
def auth(
    ...
    from valor.cli.operator import authenticate_user
...
def login(
    ...
    * `phi login`
    ...
    from valor.cli.operator import sign_in_using_cli
...
def ping(
    ...
    from valor.api.user import user_ping
    from valor.cli.console import print_info
...
def set(
    ...
    """
    from valor.workspace.operator import set_workspace_as_active
...
def ai(
    ...
    from valor.cli.config import PhiCliConfig
    from valor.cli.operator import initialize_phi
    from valor.cli.console import log_config_not_available_msg
    from valor.ai.operator import phi_ai_conversation
...
def start(
    ...
    from valor.cli.config import PhiCliConfig
    from valor.cli.console import log_config_not_available_msg
    from valor.cli.operator import start_resources, initialize_phi
...
def stop(
    ...
    from valor.cli.config import PhiCliConfig
    from valor.cli.console import log_config_not_available_msg
    from valor.cli.operator import stop_resources, initialize_phi
    from valor.infra.type import InfraType
...
def patch(
    ...
    from valor.cli.config import PhiCliConfig
    from valor.cli.console import log_config_not_available_msg
    from valor.cli.operator import patch_resources, initialize_phi
    from valor.infra.type import InfraType
