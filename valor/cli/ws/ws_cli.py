...
def create(
    ...
    from valor.workspace.operator import create_workspace
...
def setup(
    ...
    from valor.workspace.operator import setup_workspace
...
def up(
    ...
    from valor.workspace.operator import start_workspace
    from valor.utils.resource_filter import parse_resource_filter
...
def down(
    ...
    from valor.cli.config import PhiCliConfig
    from valor.workspace.config import WorkspaceConfig
    from valor.workspace.operator import stop_workspace
    from valor.utils.resource_filter import parse_resource_filter
...
def patch(
    ...
    from valor.cli.config import PhiCliConfig
    from valor.workspace.config import WorkspaceConfig
    from valor.workspace.operator import update_workspace
    from valor.utils.resource_filter import parse_resource_filter
...
def delete(
    ...
    """\b
    Deletes the workspace record from valor.
    ...
    from valor.cli.config import PhiCliConfig
    from valor.workspace.operator import delete_workspace
