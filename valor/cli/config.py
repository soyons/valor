...
from valor.cli.console import print_heading, print_info
from valor.cli.settings import phi_cli_settings
from valor.api.schemas.user import UserSchema
from valor.api.schemas.workspace import WorkspaceSchema, WorkspaceDelete
from valor.utils.log import logger
from valor.utils.json_io import read_json_file, write_json_file
...
class PhiCliConfig:
    ...
    def delete_ws(self, ws_root_path: Path) -> None:
        ...
        if self.user is not None and ws_config.ws_schema is not None:
            ...
            from valor.api.workspace import delete_workspace_for_user
