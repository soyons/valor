...
from valor.api.ai import conversation_chat
from valor.api.schemas.user import UserSchema
from valor.api.schemas.ai import ConversationType
...
from valor.llm.message import Message
from valor.tools.function import Function, FunctionCall
from valor.tools.shell import ShellTools
from valor.tools.phi import PhiTools
from valor.workspace.config import WorkspaceConfig
from valor.utils.log import logger
from valor.utils.functions import get_function_call
from valor.utils.timer import Timer
from valor.utils.json_io import write_json_file, read_json_file
...
class PhiAI:
    def __init__(
        ...
        if _conversation_id is None:
            from valor.api.ai import conversation_create, ConversationCreateResponse
    ...
    #     from rich.table import Table
    #     from rich.markdown import Markdown
    #     from valor.api.ai import ai_ws_connect
    #
