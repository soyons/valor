...
from valor.app.base import AppBase
from valor.app.context import ContainerContext
from valor.k8s.app.context import K8sBuildContext
from valor.k8s.enums.restart_policy import RestartPolicy
from valor.k8s.enums.image_pull_policy import ImagePullPolicy
from valor.k8s.enums.service_type import ServiceType
from valor.utils.log import logger

if TYPE_CHECKING:
    from valor.k8s.resource.base import K8sResource
...
class K8sApp(AppBase):
            ...
            if self.enable_https:
                ...
                if self.acm_certificate_summary_file is not None and isinstance(
                    ...
                    if self.acm_certificate_summary_file.exists() and self.acm_certificate_summary_file.is_file():
                        from valor.aws.resource.acm.certificate import CertificateSummary
    ...
    def get_ingress_name(self) -> str:
        from valor.utils.defaults import get_default_ingress_name
    ...
    def get_cr_policy_rules(self) -> List[Any]:
        from valor.k8s.create.rbac_authorization_k8s_io.v1.cluster_role import (
            PolicyRule,
        )
    ...
    def build_resources(self, build_context: K8sBuildContext) -> List["K8sResource"]:
        from valor.k8s.create.apps.v1.deployment import CreateDeployment
        from valor.k8s.create.base import CreateK8sResource
        from valor.k8s.create.common.port import CreatePort
        from valor.k8s.create.core.v1.config_map import CreateConfigMap
        from valor.k8s.create.core.v1.container import CreateContainer
        from valor.k8s.create.core.v1.namespace import CreateNamespace
        from valor.k8s.create.core.v1.secret import CreateSecret
        from valor.k8s.create.core.v1.service import CreateService
        from valor.k8s.create.core.v1.service_account import CreateServiceAccount
        from valor.k8s.create.core.v1.volume import (
            CreateVolume,
            HostPathVolumeSource,
            AwsElasticBlockStoreVolumeSource,
            VolumeType,
        )
        from valor.k8s.create.networking_k8s_io.v1.ingress import CreateIngress
        from valor.k8s.create.rbac_authorization_k8s_io.v1.cluste_role_binding import CreateClusterRoleBinding
        from valor.k8s.create.rbac_authorization_k8s_io.v1.cluster_role import CreateClusterRole
        from valor.k8s.resource.base import K8sResource
        from valor.k8s.resource.yaml import YamlResource
        from valor.utils.defaults import get_default_volume_name, get_default_sa_name
