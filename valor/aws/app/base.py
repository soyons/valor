...
from valor.app.base import AppBase  # noqa: F401
from valor.app.context import ContainerContext
from valor.aws.app.context import AwsBuildContext
...
if TYPE_CHECKING:
    ...
    from valor.aws.resource.ecs.container import EcsContainer
...
class AwsApp(AppBase):
    ...
    def get_load_balancer_security_groups(self) -> Optional[List["SecurityGroup"]]:
        from valor.aws.resource.ec2.security_group import SecurityGroup, InboundRule
    ...
    def security_group_definition(self) -> "SecurityGroup":
        from valor.aws.resource.ec2.security_group import SecurityGroup, InboundRule
        from valor.aws.resource.reference import AwsReference
    ...
    def build_resources(self, build_context: AwsBuildContext) -> List["AwsResource"]:
        ...
        from valor.aws.resource.ecs.task_definition import EcsTaskDefinition
        from valor.aws.resource.ecs.service import EcsService
        from valor.aws.resource.ecs.volume import EcsVolume
        from valor.docker.resource.image import DockerImage
        from valor.utils.defaults import get_default_volume_name
