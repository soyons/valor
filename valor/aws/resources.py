...
from valor.aws.app.base import AwsApp
from valor.aws.app.context import AwsBuildContext
from valor.aws.api_client import AwsApiClient
...
class AwsResources(InfraResources):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from valor.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from os import getenv
        from valor.constants import AWS_PROFILE_ENV_VAR
    ...
    def create_resources(
        ...
        from valor.aws.resource.types import AwsResourceInstallOrder
