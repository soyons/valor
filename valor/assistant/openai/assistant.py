...
from valor.assistant.openai.file import File
from valor.assistant.openai.exceptions import AssistantIdNotSet
...
class OpenAIAssistant(BaseModel):
    ...
    #     from valor.assistant.openai.thread import Thread
    #
