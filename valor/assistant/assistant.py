...
from valor.llm.references import References  # noqa: F401
from valor.memory.assistant import AssistantMemory
from valor.prompt.template import PromptTemplate
from valor.storage.assistant import AssistantStorage
...
from valor.utils.merge_dict import merge_dictionaries
...
class Assistant(BaseModel):
    ...
    def _api_log_assistant_run(self):
        ...
        from valor.api.assistant import create_assistant_run, AssistantRunCreate
    ...
    def _api_log_assistant_event(self, event_type: str = "run", event_data: Optional[Dict[str, Any]] = None) -> None:
        ...
        from valor.api.assistant import create_assistant_event, AssistantEventCreate
